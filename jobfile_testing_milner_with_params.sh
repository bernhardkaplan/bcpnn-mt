...
aprun -n 20 -N 20 -S 20 python /cfs/milner/scratch/b/bkaplan/bcpnn-mt/main_test.py connection_matrix_20x4_taui5_v0.4_0.8.dat connection_matrix_20x4_taui200_v0.4_0.8.dat $1 $2 $3 $4 $5 $6 $7 $8 $9 > delme_test_$1_$2_$3_$4_$5_$6 2>&1
