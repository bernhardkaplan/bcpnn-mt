...
aprun -n 20 -N 20 -S 10 python /cfs/milner/scratch/b/bkaplan/bcpnn-mt/main_test.py connection_matrix_20x16_taui5.dat connection_matrix_20x16_taui150.dat $1 > delme_test_$1_$2_$3 2>&1
