...
aprun -n 20 -N 20 -S 20 python /cfs/milner/scratch/b/bkaplan/bcpnn-mt/main_test.py connection_matrix_20x16_taui5_trained_with_AMPA_input_only.dat connection_matrix_20x16_taui150_trained_with_AMPA_input_only.dat $1 $2 $3 $4 > delme_test_$1_$2_$3_$4 2>&1
