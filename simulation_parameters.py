...
class parameter_storage(object):
    ...
    def set_default_params(self):
        ...
        self.params['v_max_tp'] = 0.2  # [Hz] maximal velocity in visual space for tuning proprties (for each component), 1. means the whole visual field is traversed within 1 second
