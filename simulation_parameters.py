...
#        self.params['connectivity'] = 'isotropic'
#        self.params['connectivity'] = 'random'
...
#        self.params['p_ie'] = 1.
        ...
        self.params['standard_delay'] = 2           # [ms]
...
#        tau_p = self.params['t_sim'] * 0.33 # * self.n_stim# * self.n_cycles # tau_p should be in the order of t_stimulus * n_iterations * n_cycles
        ...
        self.params['v_max_tp'] = 0.40  # [a.u.] maximal velocity in visual space for tuning_parameters (for each component), 1. means the whole visual field is traversed
