...
#        np.savetxt(fn_out, self.debug_tau_zi)
    ...
    def connect_ee_testing(self):
        ...
        # 1) AMPA / NMDA normalization determined by ampa_nmda_ratio
        # the target ampa_nmda_ratio / target_ratio_ampa_nmda determines a correction factor for both components
