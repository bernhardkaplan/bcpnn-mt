...
def plot_weight_and_delay_hist(params, conn_type=None):
    if conn_type == None:
        conn_type = 'ee'
...
if __name__ == '__main__':
    ...
    # if conn_type not set as additional argument, plot the e-e connections
    plot_weight_and_delay_hist(params, conn_type)
