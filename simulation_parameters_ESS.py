...
class parameter_storage(object):
    ...
    def set_default_params(self):
        self.params['simulator'] = 'hw_ess'
        self.params['hardware_setup'] = 'medium'
        """
        hardwareSetup   #HICANNs    #Neurons
        'one-hicann'    1   59
        'one-reticle'   8 (4x2)     472
        'small'     32( 8x4)    1888
        'medium'    128 (16x8)  7552
        'medium2'   128 (32x4)  7552
        'large'     240 (20x12)     14160
        'large2'    224 (28x8)  13216
        'one-wafer'     384     22656
        """
...
#        self.params['p_to_w'] =
        ...
        self.params['w_input_exc'] = 5.00e-2 * 5. / self.params['tau_syn_exc']    # [uS] mean value for input stimulus ---< exc_units (columns
...
#        self.params['input_folder'] = "%sInputSpikeTrains/"   % self.params['folder_name']# folder containing the input spike trains for the network generated from a certain stimulus
        ...
        # ESS specific files
        self.params['realized_conn_file'] = '%srealized_connections.txt' % (self.params['connections_folder'])
        self.params['lost_conn_file'] = '%slost_connections.txt' % (self.params['connections_folder'])
