...
def bcpnn_offline_noColumns(params, connection_matrix, sim_cnt=0, pc_id=0, n_proc=1, save_all=True):
    """
    Arguments:
    ...
    np.savetxt(params['conn_list_ee_fn_base'] + str(sim_cnt+1) + '.dat', connection_matrix)
